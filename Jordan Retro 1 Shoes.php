...
<body>
  ...
  <div class="grid-container2">
    ...
    <div class="card1">
      <img src="./photos/Jordan Retro 1 shoes.jpg" alt="Black Mamba Shorts" style="width: 200%" />
    </div>

    <div class="card2">
      <h1 style="margin-top: 60px;">Jordan Retro 1 Shoes</h1>
      <p class="price">$120</p>
      ...
      <h3 id="productinfo">Feel the rush of the air beneath your feet as you rise up to the horizons for a vicious
        one-hand throw down, whenever you put on the OG Air Jordan Retro Shoes. Trust us, with the increased Air-Time,
        no one's catch up any time soon </h3>
