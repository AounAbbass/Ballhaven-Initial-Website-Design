...
<body>
  ...
  <div class="grid-container2">
    ...
    <div class="card1">
      <img src="./photos/Michael Jordan Jersey.jpg" alt="Michael Jordan Jersey" style="width: 200%" />
    </div>

    <div class="card2">
      <h1 style="margin-top: 60px;">Lebron James Jersey</h1>
      ...
      <h3 id="productinfo">The Peak of Mount Rushmore of Basketball awaits. Bring out the G.O.A.T within you everytime
        you wear MJ's signature Chicago Bulls Jersey. Every short turns clutch and every basket counts!</h3>
