...
<body>
  ...
  <div class="grid-container2">
    ...
    <div class="card1">
      <img src="./photos/Spalding Genuine Basketball.jpg" alt="Spalding Genuine Basketball" style="width: 200%" />
    </div>

    <div class="card2">
      <h1 style="margin-top: 60px;">Spalding Genuine Indoor/Outdoor Basketball</h1>
      ...
      <h3 id="productinfo">Go intergalactic with your increased vertical when wearing the Space Jame movie star Lebron
        James' shoes. Every threat on Earth or beyond, can be overcome with these sick kicks</h3>
