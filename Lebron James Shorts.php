...
<body>
  ...
  <div class="grid-container2">
    ...
    <div class="card1">
      <img src="./photos/Lebron James Shorts.jpg" alt="Lebron James Shorts" style="width: 200%" />
    </div>

    <div class="card2">
      <h1 style="margin-top: 60px;">Lebron James Shorts</h1>
      ...
      <h3 id="productinfo">To be like the King, you gotta suit up to every game like the King! With the Lebron Soldier
        Shorts on, feel the spirit of Lebron James channel through your veins as you throw it down to victory! </h3>
